...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for kycservice")
public class HelloController {

    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to kycservice";
    }
    ...
    // Note: Actuator also exposes /actuator/health and /actuator/info
    @GetMapping("/health")
    @Operation(summary = "Legacy health check", description = "Returns OK (prefer /actuator/health).")
    ...
    public String info() {
        return "Spring Boot Application: kycservice";
    }
}
